...
#Inicializamos un diccionario vacío que vamos a usar para almacenar los gastos en cada categoría
gasto_categoria = {}
...
for categoria in categorias_gastos:
  ...
  gasto_categoria[categoria] = gasto #En el diccionario gasto_categoria, vamos a almacenar los datos que el usuario añada a la variable gastos, con la categoria como clave
  #gasto_categoria = {"Alimentacion": gasto, "Transporte":gasto,....}
